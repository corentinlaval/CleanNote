...
# adapte l'import si ton module s'appelle autrement
...
def test_load_sets_defaults_and_pad_token(patch_transformers, capsys):
    ...
    # _ensure_pad_token : eos_token -> pad_token si None
    tok = FakeTokenizer(pad_token_id=None, eos_token_id=1)
    # vérifier indirectement via l'appel dans load()
    # (on ne récupère pas l’instance réelle ici, mais on a déjà exercé ce chemin)
